...
import (
	...
	"github.com/onuryurdupak/go-mssqldb/internal/querytext"
	"github.com/onuryurdupak/go-mssqldb/msdsn"
)
...
func init() {
	sql.Register("mssql_legacy", driverInstance)
	sql.Register("sqlserver_legacy", driverInstanceNoProcess)
