...
[![Go Reference](https://pkg.go.dev/badge/github.com/onuryurdupak/go-mssqldb.svg)](https://pkg.go.dev/github.com/onuryurdupak/go-mssqldb)
...
Install with `go get github.com/onuryurdupak/go-mssqldb` .
...
import (
  ...
  "github.com/onuryurdupak/go-mssqldb/azuread"
)
...
* [NewConnector](https://godoc.org/github.com/onuryurdupak/go-mssqldb#NewConnector)
    may be used with [OpenDB](https://golang.org/pkg/database/sql/#OpenDB).
* [Connector.SessionInitSQL](https://godoc.org/github.com/onuryurdupak/go-mssqldb#Connector.SessionInitSQL)
